...
export function StoryItem({id, rank}: StoryItemProps) {
  ...
  const isPopular = (story.descendants ?? 0) > 500;
      ...
      <div className="story-content">
        ...
        <div className="story-meta">
          <span className={`story-points${isHot ? ' story-points--hot' : ''}`}>
            <svg fill="currentColor" height="14" viewBox="0 0 20 20" width="14" aria-hidden="true">
          ...
          <span className={`story-comments${isPopular ? ' story-comments--hot' : ''}`}>
            <svg
              width="14"
              height="14"
              viewBox="0 0 24 24"
